      ...
      <Container size="xl" className="py-12 relative z-10">
        ...
        <section className="mb-16">
          ...
          <div className="space-y-6">
            ...
            {/* Transaction Receipt */}
            <Surface padding="lg">
              <LabelText size="xs" uppercase className="mb-3 block">Transaction Receipt (Comprovante)</LabelText>
              <div className="grid grid-cols-2 gap-6">
                {/* Depósito Confirmado */}
                <TransactionReceipt
                  type="deposit"
                  ...
                  amountNet={97.01}
                  timestamp={new Date()}
                  taxDocument="529.836.700-25"
                  walletAddress="lq1qqwhzwwnaqmw83gnck8wa3t474tw20e4szuvu3j74qzvpal65e4j2yv3eeveu3x3ueasv7a55sxzc4j8wnw2nc8p9nm62dcl5f"
                  blockchainTxId="tx_9f8e7d6c5b4a3210fedcba9876543210"
                />
