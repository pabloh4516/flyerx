    ...
    <Container size="lg" padded={false} className="p-6 flex flex-col gap-5">
      ...
      <div className="rounded-xl border border-accent/30 bg-accent/5 p-4">
        <div className="flex gap-3">
          ...
          <div>
            <p className="text-sm text-accent-200 font-medium">Limite de chaves</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      {key.isPrimary && (
                        <span className="px-1.5 py-0.5 rounded text-[10px] bg-accent/20 text-accent-200 border border-accent/30">
                          Principal
                        </span>
                      )}
                    </div>
                    <p className="text-sm font-medium mt-0.5 font-mono">{key.value}</p>
                  </div>
                </div>
      ...
      {mockPixKeys.length === 0 && (
        <div className="rounded-xl border border-dashed border-divider p-8 text-center">
          ...
          <p className="text-sm text-neutral-400 mb-1">Nenhuma chave cadastrada</p>
