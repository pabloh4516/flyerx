<?php $__env->startSection('content'); ?>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 15px; color: #333333; line-height: 2;">
                                    <strong>Tipo de dispositivo:</strong> <?php echo e($deviceType); ?><br>
                                    <strong>Navegador:</strong> <?php echo e($browserName); ?><br>
                                    <strong>Sistema operacional:</strong> <?php echo e($osName); ?><br>
                                    <strong>Endereco IP:</strong> <?php echo e($ipAddress); ?><br>
                                    <strong>Data e hora:</strong> <?php echo e($loginTime); ?>
            ...
            <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td align="center" bgcolor="#dc3545" style="border-radius: 6px;">
                        <a href="<?php echo e($securityUrl); ?>" target="_blank" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 600; color: #ffffff; text-decoration: none; padding: 15px 40px; display: inline-block; border-radius: 6px;">
    ...
    <tr>
        <td style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; color: #333333; line-height: 1.6; padding-top: 30px;">
            Atenciosamente,<br>
            <strong>Equipe de Seguranca <?php echo e(config('app.name')); ?></strong>
        </td>
    </tr>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('emails.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\55319\Desktop\PROJETOS 2026\Flyerx\api\resources\views/emails/new-device-detected.blade.php ENDPATH**/ ?>