                    ...
                    <tr>
                        <td align="center" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #ffffff;">
                            <h1 style="font-size: 32px; font-weight: 700; margin: 0; letter-spacing: 2px;">
                                <?php echo e(config('app.name', 'Flyerx')); ?>
                    ...
                    <tr>
                        <td align="center" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; color: #666666; line-height: 1.6;">
                            <p style="margin: 0 0 10px 0;">
                                &copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name', 'Flyerx')); ?>. Todos os direitos reservados.
                            </p>
                            <p style="margin: 0 0 10px 0;">
                                Este email foi enviado automaticamente. Por favor, nao responda.
                            </p>
                            <?php if(isset($supportEmail)): ?>
                            <p style="margin: 0;">
                                Duvidas? Entre em contato: <a href="mailto:<?php echo e($supportEmail); ?>" style="color: #1a1a2e; text-decoration: underline;"><?php echo e($supportEmail); ?></a>
                            </p>
                            <?php endif; ?>
                        </td>
                    </tr>
...
<?php /**PATH C:\Users\55319\Desktop\PROJETOS 2026\Flyerx\api\resources\views/emails/layout.blade.php ENDPATH**/ ?>