...
@section('content')
    ...
    <tr>
        <td style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; color: #333333; line-height: 1.6; padding-bottom: 30px;">
            Obrigado por se cadastrar no {{ config('app.name') }}. Para completar seu cadastro e ativar sua conta, por favor clique no botao abaixo para verificar seu endereco de email.
        </td>
    </tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td align="center" bgcolor="#1a1a2e" style="border-radius: 6px;">
                        <a href="{{ $verificationUrl }}" target="_blank" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 600; color: #ffffff; text-decoration: none; padding: 15px 40px; display: inline-block; border-radius: 6px;">
                            Verificar Email
                        </a>
                    </td>
                </tr>
    ...
    <tr>
        <td style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; color: #999999; line-height: 1.6; padding-top: 20px;">
            <strong>Importante:</strong> Este link expira em {{ $expirationHours ?? 24 }} horas.
        </td>
    </tr>
    ...
    <tr>
        <td style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; color: #999999; line-height: 1.6; padding-top: 15px;">
            Se voce nao criou uma conta no {{ config('app.name') }}, pode ignorar este email.
        </td>
    </tr>
@endsection
